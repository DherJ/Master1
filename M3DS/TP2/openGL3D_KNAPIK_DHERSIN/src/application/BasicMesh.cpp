...
void BasicMesh::initObj(const ObjLoader &obj) {
  ...
  for(unsigned int i=0;i<obj.nbFace();++i) {
    ...
    // TODO - QUESTION 17
        ...
        Vector3 normal = obj.normalVertex(i,j);
        _attribute.push_back(normal.x());
        _attribute.push_back(normal.y());
        _attribute.push_back(normal.z());
    }
  }
