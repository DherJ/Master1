...
/**
 * Class which represent the graphical view (frame) of the
 * game.
 */
public class GameFrame extends JFrame implements MouseListener {
	...
	public void initFrame() {
		...
		nbCoupsBotLabel.setBounds(10, 90, 180, 20);
		nbCoupsJoueurLabel = new JLabel(NBCOUPSJOUEURSTRING + "00");
		nbCoupsJoueurLabel.setBounds(10, 110, 180, 20);
	...
	public void paint(Graphics g) {
		...
		drawBadCase(g2);
		if(game.isBot()) {
			playerLabel.setText("Bot play");
			playerLabel.setForeground(COLORBOT);
		}
		else {
			playerLabel.setText("You play");
	...
	public void congrats(boolean win) {
		if(win)
			...
			JOptionPane.showMessageDialog(null, "GAME OVER, I'm too strong for you noob !", "End of the game", JOptionPane.INFORMATION_MESSAGE);
	}
